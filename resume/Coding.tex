...
\begin{cventries}
	...
	\cventry
	{} % Empty position
	{\href{https://github.com/shenmishajing/project_template}{\textcolor{link}{project\_template}}: A template project based on \href{https://github.com/Lightning-AI/lightning}{\textcolor{link}{Pytorch-lightning}}} % Project
	{\hfill} % Empty location
	{} % Empty date
	{
		\vspace{-3.5mm}
